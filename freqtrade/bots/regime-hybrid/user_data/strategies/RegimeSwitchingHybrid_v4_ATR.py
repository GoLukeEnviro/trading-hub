...
class RegimeSwitchingHybrid_v4_ATR(IStrategy):
    ...
    # Hyperoptable parameters (Buy space) - Starting with v3 best
    adx_threshold = IntParameter(20, 35, default=29, space="buy")
    rsi_oversold = IntParameter(20, 40, default=20, space="buy")
    
    # ATR Multipliers (Sell space - new for Phase 17)
    atr_sl_trend = DecimalParameter(1.5, 4.0, default=2.5, space="sell", optimize=True)
    atr_sl_range = DecimalParameter(0.8, 2.5, default=1.5, space="sell", optimize=True)
    atr_tp_trend = DecimalParameter(1.0, 3.0, default=1.5, space="sell", optimize=True)

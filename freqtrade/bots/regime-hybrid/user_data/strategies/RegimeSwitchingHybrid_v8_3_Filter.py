"""
RegimeSwitchingHybrid_v8_3_Filter
=====================================
...
class RegimeSwitchingHybrid_v8_3_Filter(IStrategy):

    INTERFACE_VERSION = 3
    timeframe = "15m"
    can_short = False

    # ---- Baseline Exit: Tight RRR geometry ----
    # No custom_stoploss, no trailing, no protections
    stoploss = -0.01          # Hard -1% stop
    use_custom_stoploss = False
    trailing_stop = False

    minimal_roi = {
        "0": 0.02,             # Take profit at +2%, done
    }

...
Timeframe: 15m
HTF Informative: 1h
Optimized via Phase 14 Hyperopt
"""
...
class RegimeSwitchingHybrid_v2_Opt(IStrategy):
    ...
    # Hyperoptable parameters (Optimized values as defaults)
    adx_threshold = IntParameter(20, 30, default=30, space="buy")
    rsi_oversold = IntParameter(25, 40, default=26, space="buy")
